  ...
  let indice = 0
    return (
        <div style={{ padding: "3%" }}>
          ...
          <div className="container box_container2">
            <p>Want to add a new recruit?</p>
            <label></label>
            <Link to="/newRecruit"><button className="btn btn-info btn-block mb-2" style={{ backgroundColor: "#1d57a8", borderColor: "#1d57a8" }}>Create a New Recruit</button></Link>
          </div>
        </div>
    )
}