...
export default ({ handleSubmit, handleChange }) => {
    ...
    return (
        <Fragment style={{marginTop:"50px", marginBottom:"50px"}}>
            ...
            <section id="banner_white">
                ...
                <button className="btn btn-info btn-block mb-2" style={{ backgroundColor: "#adb5bd", borderColor: "#adb5bd" }}>Save Changes</button>
                </form>
                </div>
                </div>
            </section>
