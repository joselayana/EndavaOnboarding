...
class UsersAdminContainer extends React.Component {
    ...
    handleProfile(idUser, state) {
        this.props.changeProfile(idUser, state)
    ...
    render() {
        return (
            <Fragment>
                <UsersAdmin handleSubmit={this.handleSubmit} handleChange={this.handleChange} state={this.state} users={this.props.users} handleProfile={this.handleProfile} />
            </Fragment>
        )
    }
}
...
const mapDispatchToProps = (dispatch, ownProps) => {
    return {
        ...
        changeProfile: (idUser, state) => dispatch(changeProfile(idUser, state))
    }
};
