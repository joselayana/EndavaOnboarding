        ...
        return (
            ...
            <Fragment>
                <div class="parent">
                    ...
                    <div class="div2">
                        <MyPendingTasks user={this.props.user} handleSearchInput={this.handleSearchInput} tasks={this.props.tasks} handleChange={this.handleChange} handleClick={this.handleClick} />
                    </div>
                </div>
            </Fragment>
        )
