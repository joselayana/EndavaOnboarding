...
class TeamFinishedTasksContainer extends React.Component {
    ...
    handleSearchInputS(e) {
        ...
        (busqueda.length >= 2) ? this.props.searchAllFinishedTasks(busqueda, 1) : this.props.searchAllFinishedTasks()
    }

    handleSearchInputT(e) {
        this.setState({ busquedaT: e.target.value })
        const busqueda = e.target.value;
        (busqueda.length >= 2) ? this.props.searchAllFinishedTasks(busqueda, 2) : this.props.searchAllFinishedTasks()
    }
