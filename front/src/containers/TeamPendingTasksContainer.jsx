        ...
        return (
            <Fragment>
                <div class="parent">
                    ...
                    <div class="div2">
                        <TeamPendingTasks user={this.props.user} allTasks={this.props.allTasks} handleSearchInputS={this.handleSearchInputS} handleSearchInputT={this.handleSearchInputT} />
                    </div>
                </div>
            </Fragment>
        )
